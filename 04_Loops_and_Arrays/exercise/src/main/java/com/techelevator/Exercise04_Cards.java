...
public class Exercise04_Cards {
     ...
     * 
     * Examples:
     * discardFirstCard(["3-H", "7-H", "5-H", "8-H", "6-H"]) → ["7-H", "5-H", "8-H",
     * "6-H"]
     * discardFirstCard(["1-C", "1-D", "1-H", "1-S", "2-C"]) → ["1-D", "1-H", "1-S",
     * "2-C"]
     * discardFirstCard(["K-C", "Q-D", "J-H", "10-S", "Q-C"]) → ["Q-D", "J-H",
     * "10-S", "Q-C"]
     */
    public String[] discardFirstCard(String[] hand) {
        String[] newDeck = new String[hand.length - 1];
     ...
     * 
     * Examples:
     * discardTopCard(["8-D", "10-H", "J-C", "8-D", "6-S", "Q-C", "2-D"]) → ["10-H",
     * "J-C", "8-D", "6-S", "Q-C", "2-D"]
