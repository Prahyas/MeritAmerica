...
public class Exercise02_CanDrive {
     ...
     * Implement the logic to return true if the person has a permit and is with a
     * licensed passenger who is 21 or over.
     * 
     * Examples:
    ...
    /*
     * If the licensed passenger is the driver's legal guardian, they only have to
     * be 18 instead of 21.
     * Implement the logic to return true if the person has a permit and is with a
     * licensed passenger.
     * The licensed passenger only needs to be 18 or older if they're the driver's
     * guardian. Otherwise, the passenger must be 21 or older.
     * 
     * Examples:
    ...
    public boolean canDrive(boolean hasPermit, boolean withLicensedPassenger, int passengerAge,
        ...
        return hasPermit && withLicensedPassenger
                && ((isPassengerOurGuardian && passengerAge >= 18) || (!isPassengerOurGuardian && passengerAge >= 21));
    }
}
