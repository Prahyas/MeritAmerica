...
public class Exercise01_TestGrading {
     ...
     * The problems below ask you to implement the logic for returning a grade based
     * on a student's test score.
     */

    /*
     * Grade-o-matic v1.0 scores tests as pass-fail.
     * A score of 70 or higher is a passing score. Anything lower is a failing
     * score.
    ...
    /*
     * Grade-o-matic received numerous requests from customers to grade using a
     * point-based system.
    ...
    /*
     * Grade-o-matic has received even more requests to grade using the classic
     * letter scale.
