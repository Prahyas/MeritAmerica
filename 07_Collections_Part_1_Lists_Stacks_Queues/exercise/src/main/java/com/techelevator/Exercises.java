...
public class Exercises {
    ...
    public List<String> array2List(String[] stringArray) {
        List<String> newArray = new ArrayList<>(Arrays.asList(stringArray));
        return newArray;
    }
     ...
     * list2Array( ["Left", "Right", "Forward", "Back"] ) -> {"Left", "Right",
     * "Forward", "Back"}
     */
    ...
    public List<String> no4LetterWords(String[] stringArray) {
        List<String> no4LetterArray = new ArrayList<>();

        for (int i = 0; i < stringArray.length; i++) {
            if (stringArray[i].length() != 4) {
                no4LetterArray.add(stringArray[i]);
            }
        }

        return no4LetterArray;
     ...
     * arrayInt2ListDouble( {84, 99, 3285, 13, 877} ) -> [42, 49.5, 1642.5, 6.5,
     * 438.5]
     */
    public List<Double> arrayInt2ListDouble(int[] intArray) {
        ...
        for (int i = 0; i < intArray.length; i++) {
            newArray.add((double) intArray[i] / 2);
        }
    ...
    public Integer findLargest(List<Integer> integerList) {
        ...
        for (int i = 0; i < integerList.size(); i++) {
            if (largestNumber < integerList.get(i)) {
    ...
    public List<Integer> oddOnly(Integer[] integerArray) {
        List<Integer> newOddOnlyArray = new ArrayList<>();

        for (int i = 0; i < integerArray.length; i++) {
            if (integerArray[i] % 2 != 0) {
                newOddOnlyArray.add(integerArray[i]);
            }
        }
        return newOddOnlyArray;
    }
     ...
     * Strings). Except any multiple of 3
     * must be replaced by the String "Fizz", any multiple of 5 must be replaced by
     * the String "Buzz",
     ...
     * fizzBuzzList( {7, 8, 9, 10, 11, 12, 13, 14, 15} ) -> ["7", "8", "Fizz",
     * "Buzz", "11", "Fizz", "13", "14", "FizzBuzz"]
     *
     * HINT: To convert an Integer x to a String, you can use x.toString() in your
     * code. For example, if x = 1, then x.toString() returns "1."
     */
    public List<String> fizzBuzzList(Integer[] integerArray) {
        ...
        for (int i = 0; i < integerArray.length; i++) {
            ...
            if (integerArray[i] % 3 == 0 && integerArray[i] % 5 == 0) {
                fizzBuzzArray.add(i, "FizzBuzz");
            } else if (integerArray[i] % 3 == 0) {
                fizzBuzzArray.add(i, "Fizz");
            } else if (integerArray[i] % 5 == 0) {
                fizzBuzzArray.add(i, "Buzz");
            } else {
                fizzBuzzArray.add(i, Integer.toString(integerArray[i]));
            }
        }
    ...
    public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
        List<Integer> interLeaveArray = new ArrayList<>();


        int minimumLengthOfArrays = Math.min(listOne.size(), listTwo.size());

        for (int i = 0; i < minimumLengthOfArrays; i++) {
            interLeaveArray.add(listOne.get(i));
            interLeaveArray.add(listTwo.get(i));
        }

        List<Integer> longestList = listOne.size() > listTwo.size() ? listOne : listTwo;
        for (int i = minimumLengthOfArrays; i < longestList.size(); i++) {
            interLeaveArray.add(longestList.get(i));
        }
