...
public class Exercise05_Weather {
    ...
    /*
     * GaleForce Meteorologists recently developed a new weather station and need it
     * to perform
    ...
    /*
     * GaleForce also needs to determine the hottest day when given an upcoming
     * forecast.
     * 
    ...
    /*
     * GaleForce discovered an equipment malfunction. Every other reading, starting
     * with the first,
     * was off by 2 degrees Fahrenheit (°F).
     * 
     * Given an array of Fahrenheit temperatures, fix each of the incorrect readings
     * by adding
