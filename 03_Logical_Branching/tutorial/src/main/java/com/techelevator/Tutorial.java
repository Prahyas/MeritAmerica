...
public class Tutorial {
        public static void main(String[] args) {
                 ...
                 * This program tells the user how to prepare for their day based on weather
                 * conditions.
                 *************************************************/
                ...
                System.out.println("Expected high temperature: " + highTemperatureF + "\u00B0F."); // Degrees character
                                                                                                   // in Unicode: \u00B0
                ...
                // Step Four: Determine if the user should bring a coat. (when the temperature <
                // 65°F)
                ...
                // Step Six: Advise the user on the type of jacket they should be wearing. (<=
                // 0°F, <= freezing, < 65°F)
                ...
                // Step Seven: If the temperature delta for the day is more than 20°F, advise
                // the user to dress in layers.
